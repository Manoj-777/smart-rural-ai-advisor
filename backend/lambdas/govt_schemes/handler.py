...
STATE_SCHEMES = {
    "Tamil Nadu": [
        ...
        {"name": "TN IAMP (Irrigated Agriculture Modernization Project)", "benefit": "World Bank-assisted modernization of irrigation systems", "eligibility": "Farmers in project-covered sub-basins", "how_to_apply": "Through Water Resources Department and district agriculture office", "documents": "Patta, Aadhaar card, bank passbook, sub-basin location proof", "deadline": "Project-based; contact district agriculture office for current phase deadlines"},
    ],
    "Andhra Pradesh": [
        {"name": "YSR Rythu Bharosa", "benefit": "₹13,500/year per farmer family (₹7,500 state + ₹6,000 PM-KISAN combined)", "eligibility": "All registered farmer families in AP", "how_to_apply": "Auto-enrolled if registered in AP farmer database; verify at nearest MRO office", "documents": "Aadhaar card, land records (1B/adangal), bank passbook linked to Aadhaar", "deadline": "Continuous enrollment; payments in May, Oct, Jan installments"},
        {"name": "YSR Free Crop Insurance", "benefit": "State pays farmer premium share of PMFBY — effectively free crop insurance", "eligibility": "All AP farmers growing notified crops", "how_to_apply": "Auto-enrolled through banks/cooperative societies during crop loan", "documents": "Aadhaar, crop loan documents, e-crop booking registration", "deadline": "Kharif: before July 31; Rabi: before December 31"},
        {"name": "E-Crop Registration", "benefit": "Mandatory digital crop booking for accessing all scheme benefits", "eligibility": "All AP farmers", "how_to_apply": "Register at village/ward secretariat or through Meeseva centres", "documents": "Aadhaar, land records (1B), mobile number", "deadline": "Within 2 weeks of crop sowing each season"},
    ],
    "Telangana": [
    ...
    "Kerala": [
        {"name": "Haritashree", "benefit": "₹50/seedling for tree planting and agroforestry on farmlands", "eligibility": "All Kerala farmers", "how_to_apply": "Apply through Krishi Bhavan (village-level agriculture office)", "documents": "Aadhaar, land records (thandaper), bank passbook, planting proposal", "deadline": "Before monsoon planting season (June–July)"},
        {"name": "Subhiksha Keralam", "benefit": "Input subsidies for rice, vegetable, and tuber cultivation", "eligibility": "All Kerala farmers promoting food security crops", "how_to_apply": "Register through Krishi Bhavan or krishibhavan.kerala.gov.in", "documents": "Aadhaar, land records, bank passbook, crop plan declaration", "deadline": "Before each cropping season; register at Krishi Bhavan"},
        {"name": "Jeevani", "benefit": "Free crop insurance for paddy, banana, and pepper farmers", "eligibility": "Paddy, banana, and pepper farmers in Kerala", "how_to_apply": "Apply through Krishi Bhavan before sowing season", "documents": "Aadhaar, land records (thandaper), crop details, bank passbook", "deadline": "Before sowing season (varies by crop: paddy June/Oct, banana year-round)"},
    ],
    "Madhya Pradesh": [
        {"name": "Bhavantar Bhugtan Yojana", "benefit": "Price deficiency payment — government pays difference if market price falls below MSP", "eligibility": "All MP farmers selling notified crops", "how_to_apply": "Register on mpeuparjan.nic.in before harvest season", "documents": "Aadhaar, Khasra/B1 (land record), bank passbook, mobile number", "deadline": "Register 7 days before selling; check mpeuparjan.nic.in for crop-wise windows"},
